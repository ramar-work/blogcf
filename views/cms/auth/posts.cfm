...
<div class="container">
	...
	<table class="admin" summary="A list of your most recent posts">
		<a class="admin-selection" href="#model.base.href.new#">
		...
		<tbody>
		<cfloop query=#model.collection#>
			<tr class="admin-selection as-alt">
				<!--- The title and a link to the post --->
				<td class="name">
					<a class="admin-selection" href="#model.base.href.edit#/#collection_long_id#">#collection_name#</a>
				</td>
				...
				<td>
					<a class="admin-delete" id="#collection_long_id#">Delete</a>
				</td>
			</tr>
		</cfloop>
		</tbody>
